...
var line = {
    ...
    addPoint: function (pointerPositionL, pointerPositionR, orientation, pressure, timestamp) {
        const pointerPosition = pointerPositionR;
        var uv = 0;
        ...
        var posA = pointerPositionL.clone();
        var posB = pointerPositionR.clone();
